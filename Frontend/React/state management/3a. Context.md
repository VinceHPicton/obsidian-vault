Context allows you to share state down the entire component tree from where you wrap elements. Avoiding the need to manually pass state down and down the layers (called state drilling or prop drilling)
