VPC endpoints are a way to connect your VPC to other services outside it **within the same region** via the AWS private network - rather than having to go through the internet. 
