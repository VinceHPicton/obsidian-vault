...
Because [[AWS/CloudFront/CloudFront]] exists in **us-east-1**, if you are using **edge optimized** API Gateway (the default) the ACM certificates **must exist in us-east-1**
